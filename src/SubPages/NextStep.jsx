    ...
    <div className="min-h-screen bg-white p-6 flex flex-col">
      ...
      <div className="bg-white p-6 md:p-10 rounded-lg shadow-md mt-6 max-w-3xl mx-auto w-full">
        ...
        <div className="mb-6">
          ...
          <input
            type="text"
            className="w-full mt-2 p-3 border border-gray-300 rounded-lg bg-gray-100 focus:ring-2 focus:ring-orange-500 focus:outline-none"
        ...
        <div>
          ...
          <textarea
            className="w-full mt-2 p-3 border border-gray-300 rounded-lg bg-gray-100 h-32 resize-none focus:ring-2 focus:ring-orange-500 focus:outline-none"
