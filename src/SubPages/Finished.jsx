  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between bg-[#f1f1f3] p-4 md:p-8 rounded-lg shadow-md">
        ...
        <div className="flex flex-col md:flex-row gap-4 px-2 md:px-8 w-full md:w-auto mt-4">
          ...
          <Button 
            className="w-full sm:w-auto hover:bg-orange-800 text-[#FAFAFA] rounded-md flex items-center gap-2"
      ...
      <div className="mx-2 md:mx-8 mt-6 grid grid-cols-1 md:grid-cols-6 gap-6 p-0 md:p-6">
        ...
        <div className="md:col-span-4 space-y-6">
          ...
          <div className="flex-1 flex items-center justify-center mx-2 sm:mx-4 my-4 md:my-0">
            <div className="w-full h-1 mt-12 mb-12 bg-gray-200 rounded-full relative"></div>
          </div>
          <DocCode />
        </div>
